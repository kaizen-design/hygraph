...
const FeaturedPostCard = ({ post }) => (
  <div className="group relative h-72">
    ...
    <div className="absolute transition rounded-lg bg-center bg-gradient-to-b opacity-50 from-gray-400 via-gray-700 to-black w-full h-72 group-hover:opacity-30" />
